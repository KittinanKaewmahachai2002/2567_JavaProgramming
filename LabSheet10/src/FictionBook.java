...
public class FictionBook implements Author,Book {
	...
	public boolean checkEmail() {
		return this.getEmail().endsWith("@hotmail.com")||this.getEmail().endsWith("@windowslive.com")
				?true:false;
	}
	public String toString() {
		return getTitle()+" write by "+this.getLastName().substring(0,1)+this.getFirstName()
